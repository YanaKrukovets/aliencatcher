...
export function createEntityClasses(ctx, canvas, ship, deps) {
  const { getLevel, getRockSpeed, getAlienSpeed, rockImages } = deps;
  ...
  return { Rock, Alien, Particle, FireworkParticle, MeteorRock, ReverseAlien, UFO, SOSAlien, GravityWell, LastEgg };
}
